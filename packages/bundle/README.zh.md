...
| [`workforce-global`](workforce-global/README.zh.md) | 基于 base 的 Workforce 全局 profile 层（目前为空） | —（仅 patch） |
| [`workforce-cell`](workforce-cell/README.zh.md) | 基于 base + headless 的 Workforce Cell profile 层（目前为空） | —（仅 patch） |
