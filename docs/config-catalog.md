...
- `@deepseek-ai/dsh-workforce-session-events` — requires `sessionProjections` ([`packages/workforce/session-events/src/index.ts`](../packages/workforce/session-events/src/index.ts))
